...
export declare enum EventSubscription {
    /**
...
export declare enum RequestBatchExecutionType {
    /**
     * Not a request batch.
     *
     * Initial OBS Version: 5.0.0
...
export declare type IncomingMessage<Type = keyof IncomingMessageTypes> = Type extends keyof IncomingMessageTypes ? {
    op: Type;
    d: IncomingMessageTypes[Type];
} : never;
export declare type OutgoingMessage<Type = keyof OutgoingMessageTypes> = Type extends keyof OutgoingMessageTypes ? {
    op: Type;
...
declare type EventMessage<T = keyof OBSEventTypes> = T extends keyof OBSEventTypes ? {
    eventType: T;
    /**
...
export declare type RequestMessage<T = keyof OBSRequestTypes> = T extends keyof OBSRequestTypes ? {
    requestType: T;
    requestId: string;
    requestData: OBSRequestTypes[T];
} : never;
export declare type ResponseMessage<T = keyof OBSResponseTypes> = T extends keyof OBSResponseTypes ? {
    requestType: T;
    requestId: string;
    requestStatus: {
        result: true;
